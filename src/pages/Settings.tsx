...
import { Bell, BellOff, Bot, ChevronRight, Clock3, Info, KeyRound, Moon, Pencil, Shield, Sun, Trash2 } from "lucide-react";
  ...
  return (
    <AppShell title="Settings">
      <div className="mx-auto max-w-3xl space-y-5 px-4 py-5">
        ...
        <Link
          to="/settings/about"
          className="flex items-center justify-between gap-3 rounded-lg border border-border bg-card p-4 shadow-soft"
        >
          <div className="flex min-w-0 items-center gap-3">
            <Info className="size-4 text-primary" />
            <div className="min-w-0">
              <h2 className="font-black">About</h2>
              <p className="text-xs text-muted-foreground">Help, privacy, terms, AI, updates, and app guide</p>
            </div>
          </div>
