      ...
      systemInstruction: {
        parts: [{
          text: [
            ...
            "Use visible group names and known usernames from context. For requests like 'create a group with Gautam', use createGroup with name 'Gautam' and usernames ['gautam'].",
            "If the user clearly asks for an app action, return the closest action JSON with the fields you can infer instead of chat.",
            "Keep fields minimal.",
          ].join("\n"),
        }],
      },
